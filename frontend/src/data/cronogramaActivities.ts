...
export const CRONOGRAMA_DATA: Record<CategoryId, ActivityItem[]> = {
  ...
  general: [
    { id: '01', dateLabel: '20 ago', title: 'Definición general de arquitectura y responsabilidades.', icon: Layers, startWeek: 1, duration: 1, color: '#1D4ED8' },
    { id: '02', dateLabel: '27 ago', title: 'Checkpoint previo a Ulibro: estructuras iniciales de IA, Backend y Frontend listas.', icon: CheckSquare, startWeek: 2, duration: 1, color: '#1D4ED8' },
    { id: '03', dateLabel: '28 ago - 6 sep', title: 'ULIBRO - PERIODO BLOQUEADO. No se trabaja ni se presenta el proyecto.', icon: AlertTriangle, startWeek: 2, duration: 2, type: 'ulibro', color: '#F59E0B' },
    { id: '04', dateLabel: '8 sep', title: 'Retomar actividades y validar estado de los componentes.', icon: RotateCw, startWeek: 4, duration: 1, color: '#1D4ED8' },
    { id: '05', dateLabel: '10 sep', title: 'Primer flujo integrado utilizando mocks.', icon: Code, startWeek: 4, duration: 1, color: '#1D4ED8' },
    { id: '06', dateLabel: '17 sep', title: 'Flujo inicial caso -> interacción -> respuesta funcionando.', icon: Zap, startWeek: 5, duration: 1, color: '#1D4ED8' },
    { id: '07', dateLabel: '24 sep', title: 'Integración inicial Frontend + Backend + Agentes.', icon: Network, startWeek: 6, duration: 1, color: '#1D4ED8' },
    { id: '08', dateLabel: '1 oct', title: 'Primer flujo clínico completo con componentes reales.', icon: Stethoscope, startWeek: 7, duration: 1, color: '#1D4ED8' },
    { id: '09', dateLabel: '8 oct', title: 'AVANCE ≥60%: componentes principales funcionales.', icon: Flag, startWeek: 8, duration: 1, type: 'avance', color: '#EF4444' },
    { id: '10', dateLabel: '13-16 oct', title: 'Semana de la Ingeniería: revisión y demostraciones que correspondan.', icon: FileText, startWeek: 9, duration: 1, color: '#1D4ED8' },
    { id: '11', dateLabel: '19 oct', title: 'Inicio de integración total.', icon: Link2, startWeek: 10, duration: 1, color: '#1D4ED8' },
    { id: '12', dateLabel: '21 oct', title: 'Frontend <-> Backend funcionando sobre API real.', icon: Server, startWeek: 10, duration: 1, color: '#1D4ED8' },
    { id: '13', dateLabel: '23 oct', title: 'Backend <-> IA-Agentes funcionando.', icon: BrainCircuit, startWeek: 10, duration: 1, color: '#1D4ED8' },
    { id: '14', dateLabel: '27 oct', title: 'IA-Agentes <-> IA-Modelos funcionando.', icon: Cpu, startWeek: 11, duration: 1, color: '#1D4ED8' },
    { id: '15', dateLabel: '30 oct', title: 'SISTEMA 100% INTEGRADO.', icon: Link2, startWeek: 11, duration: 1, type: 'integrado', color: '#2563EB' },
    { id: '16', dateLabel: '2 nov', title: 'Inicio de pruebas integrales.', icon: FlaskConical, startWeek: 12, duration: 1, type: 'integrado', color: '#2563EB' },
    { id: '17', dateLabel: '4 nov', title: 'Pruebas de Backend + IA + persistencia.', icon: Activity, startWeek: 12, duration: 1, color: '#1D4ED8' },
    { id: '18', dateLabel: '6 nov', title: 'Primera ronda de correcciones.', icon: Wrench, startWeek: 12, duration: 1, color: '#1D4ED8' },
    { id: '19', dateLabel: '9 nov', title: 'Segunda ronda de pruebas y regresión.', icon: FlaskConical, startWeek: 13, duration: 1, color: '#1D4ED8' },
    { id: '20', dateLabel: '11 nov', title: 'Correcciones finales de integración, UX y rendimiento.', icon: ShieldAlert, startWeek: 13, duration: 1, color: '#1D4ED8' },
    { id: '21', dateLabel: '13 nov', title: 'RELEASE CANDIDATE + documento final/aval.', icon: CheckCircle2, startWeek: 13, duration: 1, type: 'candidata', color: '#10B981' },
    { id: '22', dateLabel: '16 nov', title: 'CODE FREEZE.', icon: Lock, startWeek: 14, duration: 1, color: '#1D4ED8' },
    { id: '23', dateLabel: '18 nov', title: 'Prueba completa de la versión congelada.', icon: Play, startWeek: 14, duration: 1, color: '#1D4ED8' },
    { id: '24', dateLabel: '19 nov', title: 'Ensayo general de demostración.', icon: Sparkles, startWeek: 14, duration: 1, color: '#1D4ED8' },
    { id: '25', dateLabel: '20 nov', title: 'VERSIÓN DEFINITIVA PARA SUSTENTACIÓN.', icon: CheckCircle2, startWeek: 14, duration: 1, type: 'final', color: '#10B981' },
    { id: '26', dateLabel: '23 nov', title: 'Ensayo/preparación final.', icon: Save, startWeek: 14, duration: 1, color: '#1D4ED8' },
    { id: '27', dateLabel: '24 nov', title: 'SUSTENTACIÓN PÚBLICA FINAL.', icon: Rocket, startWeek: 14, duration: 1, type: 'final', color: '#10B981' },
  ],
  agentes: [
